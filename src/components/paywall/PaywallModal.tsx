...
export function PaywallModal({ feature, accent, lang = 'fr', onClose, onUpgrade }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <div style={{ fontSize: 11, letterSpacing: 2, textTransform: 'uppercase', opacity: 0.4, marginBottom: 6 }}>
            Lumio+
          </div>
        ...
        <div style={{ fontSize: 14, opacity: 0.65, lineHeight: 1.6, color: '#fff' }}>
          {info.desc}
        </div>
        ...
        >
          <div style={{ fontSize: 16, fontWeight: 800, color: accent }}>
            7,99€<span style={{ fontSize: 12, fontWeight: 400 }}>/mois</span>
          </div>
          <div style={{ fontSize: 12, opacity: 0.55, marginTop: 2, color: '#fff' }}>
            ou 59,99€/an (−37%)
          </div>
        </div>

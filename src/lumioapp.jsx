...
welcome:“Bienvenue 👋”, tagline:“Ton espace de vie personnel”,
continueWith:“Continuer avec”, orEmail:“ou par email”,
firstName:“Prénom”, emailLabel:“Email”, password:“Mot de passe”,
createAccount:“Créer mon compte →”, howItWorks:“Comment ça marche ?”,
freeDesc:“Toutes les fonctions avec publicités discrètes”,
premiumDesc:“Sans pub · Toutes les fonctions premium”,
startFree:“Commencer gratuitement →”, profile:“Ton profil”,
profileHint:“Pour personnaliser ton expérience”,
},
en: {
...
welcome:“Welcome 👋”, tagline:“Your personal life space”,
continueWith:“Continue with”, orEmail:“or with email”,
firstName:“First name”, emailLabel:“Email”, password:“Password”,
createAccount:“Create my account →”, howItWorks:“How does it work?”,
freeDesc:“All features with discreet ads”,
premiumDesc:“No ads · All premium features”,
startFree:“Start for free →”, profile:“Your profile”,
profileHint:“To personalize your experience”,
},
es: {
...
insight:“✦ Insight IA”, insightText:(name,n)=>${name}, ${n} día${n>1?"s":""} de deporte seguidos. Tus noches parecen mejores esos días. ¡Sigue así! 💪,
month:“📅 Mes”, year:“🗓 Año”,
states:“🟩 Estados”, curves:“📈 Curvas”,
selectData:“Datos a mostrar”, noTrackers:“Sin indicadores activos. Añade en Hoy.”,
...
welcome:“Bienvenido 👋”, tagline:“Tu espacio de vida personal”,
continueWith:“Continuar con”, orEmail:“o con email”,
firstName:“Nombre”, emailLabel:“Email”, password:“Contraseña”,
createAccount:“Crear mi cuenta →”, howItWorks:”¿Cómo funciona?”,
freeDesc:“Todas las funciones con anuncios discretos”,
premiumDesc:“Sin anuncios · Todas las funciones premium”,
startFree:“Empezar gratis →”, profile:“Tu perfil”,
profileHint:“Para personalizar tu experiencia”,
},
de: {
...
insight:“✦ KI-Einblick”, insightText:(name,n)=>${name}, ${n} Sport-Tag${n>1?"e":""} in Folge. Deine Nächte scheinen an diesen Tagen besser. Weiter so 💪,
month:“📅 Monat”, year:“🗓 Jahr”,
states:“🟩 Zustände”, curves:“📈 Kurven”,
selectData:“Anzuzeigende Daten”, noTrackers:“Keine aktiven Indikatoren. Füge welche in Heute hinzu.”,
...
welcome:“Willkommen 👋”, tagline:“Dein persönlicher Lebensraum”,
continueWith:“Weiter mit”, orEmail:“oder per E-Mail”,
firstName:“Vorname”, emailLabel:“E-Mail”, password:“Passwort”,
createAccount:“Konto erstellen →”, howItWorks:“Wie funktioniert es?”,
freeDesc:“Alle Funktionen mit diskreter Werbung”,
premiumDesc:“Keine Werbung · Alle Premium-Funktionen”,
startFree:“Kostenlos starten →”, profile:“Dein Profil”,
profileHint:“Um deine Erfahrung zu personalisieren”,
},
it: {
...
insight:“✦ Insight IA”, insightText:(name,n)=>${name}, ${n} giorno${n>1?"i":""} di sport consecutivi. Le tue notti sembrano migliori quei giorni. Continua 💪,
month:“📅 Mese”, year:“🗓 Anno”,
states:“🟩 Stati”, curves:“📈 Curve”,
selectData:“Dati da visualizzare”, noTrackers:“Nessun indicatore attivo. Aggiungine in Oggi.”,
...
welcome:“Benvenuto 👋”, tagline:“Il tuo spazio di vita personale”,
continueWith:“Continua con”, orEmail:“o con email”,
firstName:“Nome”, emailLabel:“Email”, password:“Password”,
createAccount:“Crea il mio account →”, howItWorks:“Come funziona?”,
freeDesc:“Tutte le funzioni con pubblicità discrete”,
premiumDesc:“Senza pubblicità · Tutte le funzioni premium”,
startFree:“Inizia gratuitamente →”, profile:“Il tuo profilo”,
profileHint:“Per personalizzare la tua esperienza”,
},
pt: {
...
insight:“✦ Insight IA”, insightText:(name,n)=>${name}, ${n} dia${n>1?"s":""} seguidos de esporte. Suas noites parecem melhores nesses dias. Continue 💪,
month:“📅 Mês”, year:“🗓 Ano”,
states:“🟩 Estados”, curves:“📈 Curvas”,
selectData:“Dados a exibir”, noTrackers:“Nenhum indicador ativo. Adicione em Hoje.”,
...
welcome:“Bem-vindo 👋”, tagline:“Seu espaço de vida pessoal”,
continueWith:“Continuar com”, orEmail:“ou por e-mail”,
firstName:“Nome”, emailLabel:“E-mail”, password:“Senha”,
createAccount:“Criar minha conta →”, howItWorks:“Como funciona?”,
freeDesc:“Todas as funções com anúncios discretos”,
premiumDesc:“Sem anúncios · Todas as funções premium”,
startFree:“Começar de graça →”, profile:“Seu perfil”,
profileHint:“Para personalizar sua experiência”,
},
};
// ─── THEME SYSTEM ─────────────────────────────────────────────────────────────
const THEMES = {
...
const ADMIN_EMAIL = “admin@lumio.app”;
...
const chartData=Array.from({length:days},(,i)=>{const d=i+1,e=monthData[d],row={day:d};trackers.forEach(tk=>{const raw=e?.trackers?.[tk.id];row[tk.id]=tk.type===“bool”?(raw===true?1:raw===false?0:null):(raw??null);});return row;});
...
{Array.from({length:firstD},(,i)=><div key={e${i}}/>)}
{Array.from({length:days},(,i)=>{const d=i+1,entry=monthData[d],isToday=d===TODAY&&month===CUR_M;
...
}function Parametres({accent,setAccent,lang,setLang,gender,setGender,themeName,setThemeName,notif,setNotif,notifTime,setNotifTime,roadmap,onVote,votedIds,moods,setMoods,th}){
const t=I18N[lang]||I18N.fr;
...
return(<div style={{minHeight:“100vh”,background:th.bg,color:th.text,fontFamily:”‘Nunito’,-apple-system,sans-serif”,display:“flex”,justifyContent:“center”,alignItems:“center”,padding:“24px 20px”}}>
<style>{@import url('https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800;900&display=swap');*{box-sizing:border-box;}input{outline:none;}input::placeholder{color:${th.text3};}}</style>
<div style={{width:“100%”,maxWidth:400}}>
<div style={{display:“flex”,justifyContent:“space-between”,alignItems:“center”,marginBottom:32}}>
<div><div style={{fontSize:22,fontWeight:900,color:”#7C9EFF”}}>Lumio ✦</div><div style={{fontSize:10,color:th.text3}}>{APP_VERSION}</div></div>
<select value={lang} onChange={e=>setLang(e.target.value)} style={{background:th.bg3,border:1px solid ${th.border2},borderRadius:20,padding:“5px 12px”,color:th.text,fontSize:13,fontFamily:“inherit”,cursor:“pointer”}}>
{LANG_FLAGS.map(l=><option key={l.code} value={l.code}>{l.flag} {l.label}</option>)}
</select>
</div>
{step===1&&<>
<div style={{fontSize:22,fontWeight:800,color:th.text,marginBottom:6}}>{t.welcome}</div>
<div style={{fontSize:13,color:th.text2,marginBottom:24}}>{t.tagline}</div>
{[[“🔵 Google”,”#4285F4”],[“🔷 Facebook”,”#1877F2”]].map(([l,c])=>(<button key={l} onClick={()=>setStep(2)} style={{width:“100%”,padding:13,marginBottom:10,background:c+“15”,border:1px solid ${c}44,borderRadius:14,color:th.text,fontWeight:700,fontSize:14,cursor:“pointer”,fontFamily:“inherit”}}>{t.continueWith} {l}</button>))}
<div style={{textAlign:“center”,color:th.text3,fontSize:12,margin:“14px 0”}}>{t.orEmail}</div>
{[[t.firstName,“firstName”,“text”],[t.emailLabel,“email”,“email”],[t.password,“password”,“password”]].map(([ph,k,tp])=>(<input key={k} type={tp} placeholder={ph} value={form[k]} onChange={e=>setForm({…form,[k]:e.target.value})} style={{width:“100%”,background:th.inputBg,border:1px solid ${th.border2},borderRadius:12,padding:“11px 14px”,color:th.text,fontSize:14,fontFamily:“inherit”,marginBottom:10,boxSizing:“border-box”}}/>))}
<button onClick={()=>setStep(2)} style={{width:“100%”,padding:14,background:”#7C9EFF”,border:“none”,borderRadius:14,color:”#fff”,fontWeight:800,fontSize:15,cursor:“pointer”,fontFamily:“inherit”}}>{t.createAccount}</button>
</>}
{step===2&&<>
<div style={{fontSize:22,fontWeight:800,color:th.text,marginBottom:4}}>{t.profile}</div>
<div style={{fontSize:13,color:th.text2,marginBottom:20}}>{t.profileHint}</div>
<div style={{display:“grid”,gridTemplateColumns:“1fr 1fr”,gap:10,marginBottom:20}}>
{[[“H”,t.maleG],[“F”,t.femaleG],[“NB”,t.nbG],[“X”,t.noG]].map(([v,l])=>(<button key={v} onClick={()=>setGender(v)} style={{padding:“14px”,borderRadius:14,background:gender===v?”#7C9EFF22”:th.bg3,border:2px solid ${gender===v?"#7C9EFF":th.border},color:gender===v?”#7C9EFF”:th.text2,cursor:“pointer”,fontFamily:“inherit”,fontWeight:gender===v?700:400,fontSize:13}}>{l}</button>))}
</div>
<div style={{background:”#7C9EFF0F”,border:“1px solid #7C9EFF33”,borderRadius:14,padding:16,marginBottom:20}}>
<div style={{fontWeight:800,fontSize:15,color:”#7C9EFF”,marginBottom:8}}>{t.howItWorks}</div>
<div style={{display:“flex”,flexDirection:“column”,gap:8}}>
<div style={{display:“flex”,gap:10}}><span>🆓</span><div><div style={{fontSize:13,fontWeight:700,color:th.text}}>{t.free}</div><div style={{fontSize:12,color:th.text2}}>{t.freeDesc}</div></div></div>
<div style={{display:“flex”,gap:10}}><span>✦</span><div><div style={{fontSize:13,fontWeight:700,color:”#7C9EFF”}}>{t.premium} · 6 €/mois</div><div style={{fontSize:12,color:th.text2}}>{t.premiumDesc}</div></div></div>
</div>
</div>
<button onClick={()=>onDone({lang,firstName:form.firstName||“Toi”,gender,email:form.email})} style={{width:“100%”,padding:14,background:”#7C9EFF”,border:“none”,borderRadius:14,color:”#fff”,fontWeight:800,fontSize:15,cursor:“pointer”,fontFamily:“inherit”}}>{t.startFree}</button>
</>}
</div>
</div>);
}// ─── ROOT ─────────────────────────────────────────────────────────────────────
...
const [userInfo,setUserInfo]=useState({firstName:“Toi”,lang:“fr”,gender:””,email:””});
...
// User-customizable moods — initialized from DEFAULT_MOODS with translated labels
const [moods,setMoods]=useState(()=>DEFAULT_MOODS.map(m=>({…m,label:I18N.fr.moods[m.id]})));
// Sync mood labels when language changes
const setLang=useCallback(l=>{
setUserInfo(u=>({…u,lang:l}));
setMoods(ms=>ms.map(m=>{
// Only update label if it’s still a default mood (not custom)
...
if(screen===“onboarding”) return <Onboarding onDone={info=>{setUserInfo(info);setLang(info.lang);setScreen(“app”);}}/>;
...
<div style={{display:“flex”,alignItems:“center”,gap:8}}>
{plan===“plus”&&<span style={{fontSize:10,background:accent+“22”,border:1px solid ${accent}44,borderRadius:20,padding:“2px 8px”,color:accent,fontWeight:700}}>Lumio+</span>}
{isAdmin&&<button onClick={()=>setScreen(“admin”)} style={{background:“rgba(255,80,80,0.1)”,border:“1px solid rgba(255,80,80,0.2)”,borderRadius:8,padding:“3px 8px”,color:”#ff9999”,fontSize:10,cursor:“pointer”,fontFamily:“inherit”,fontWeight:700}}>Admin</button>}
...
{page===“settings”&&<Parametres accent={accent} setAccent={setAccent} lang={userInfo.lang} setLang={setLang} gender={userInfo.gender} setGender={g=>setUserInfo(u=>({…u,gender:g}))} themeName={themeName} setThemeName={setThemeName} notif={notif} setNotif={setNotif} notifTime={notifTime} setNotifTime={setNotifTime} roadmap={roadmap} onVote={handleVote} votedIds={votedIds} moods={moods} setMoods={setMoods} th={th}/>}
</div>
</div>
